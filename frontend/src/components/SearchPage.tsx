            ...
            <div className="flex flex-col md:flex-row justify-between gap-10">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <Button onClick={() => searchRestaurant(params.text!, searchQuery, appliedFilter)} className="bg-orange hover:bg-hoverOrange cursor-pointer">
                            Search
                        </Button>
                    </div>
                    ...
                    <div>
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
                            <h1 className="font-medium text-lg">
                                ({searchedRestaurant?.data.length}) search
                                result found
                            </h1>
                            <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                                {appliedFilter.map(
                                    (selectedFilter: string, idx: number) => (
                                        ...
                                        >
                                            <Badge
                                                className="text-[#D19254] roundex-md pr-6 whitespace-nowrap hover:cursor-pointer"
                                                variant="outline"
                                            >
                                                {selectedFilter}
                                            </Badge>
                                    ...
                                    (restaurant: Restaurant) => (
                                        ...
                                        >
                                            <div className="relative">
                                                ...
                                                <div className="absolute top-2 left-2 bg-white/75 dark:bg-gray-700/75 rounded-lg py-1 px-3">
                                            ...
                                            <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                                                <Link to={`/restaurant/${restaurant._id}`}>
                                                    <Button className="bg-orange hover:bg-hoverOrange font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200 cursor-pointer">
                                                        View Menus
                                                    </Button>
                                                </Link>
                                            </CardFooter>
